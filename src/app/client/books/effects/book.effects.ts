...
import { BooksApiActions, FindBookPageActions } from '@client/books/actions';
...
export class BookEffects {
  search$ = createEffect(() => ({ debounce = 300, scheduler = asyncScheduler } = {}) =>
    this.actions$.pipe(
      ...
      switchMap(({ query }) => {
        ...
        const nextSearch$ = this.actions$.pipe(ofType(FindBookPageActions.searchBooks), skip(1));
