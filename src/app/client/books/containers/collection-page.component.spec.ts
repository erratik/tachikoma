...
import { CollectionPageActions } from '@client/books/actions';
import { BookAuthorsComponent, BookPreviewComponent, BookPreviewListComponent } from '@client/books/components';
import { CollectionPageComponent } from '@client/books/containers';
...
describe('Collection Page', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [ NoopAnimationsModule, MatCardModule, MatInputModule, RouterTestingModule ],
      declarations: [
