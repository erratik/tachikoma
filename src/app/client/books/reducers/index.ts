...
import * as fromSearch from '@client/books/reducers/search.reducer';
import * as fromBooks from '@client/books/reducers/books.reducer';
import * as fromCollection from '@client/books/reducers/collection.reducer';
 ...
 */
export const getBooksState = createFeatureSelector<State, BooksState>(booksFeatureKey);
 ...
 */
export const getBookEntitiesState = createSelector(getBooksState, (state) => state.books);
...
export const getSelectedBook = createSelector(getBookEntities, getSelectedBookId, (entities, selectedId) => {
