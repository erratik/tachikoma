...
import { LoginPageActions, AuthActions, AuthApiActions } from '@auth/state/actions';
import { Credentials } from '@auth/models';
import { AuthService } from '@auth/services';
import { LogoutConfirmationDialogComponent } from '@auth/components';
import { UserActions } from '@shared/state/actions';
...
export class AuthEffects {
  ...
  logoutIdleUser$ = createEffect(() =>
    this.actions$.pipe(ofType(UserActions.idleTimeout), map(() => AuthActions.logout()))
  );
